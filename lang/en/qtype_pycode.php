...
$string['addingpycode'] = 'Adding a Python code question';
...
$string['shellinput'] = 'Shell Input';
$string['stdin'] = 'Standard Input (only for progs that explicitly read stdin)';
$string['failedhidden'] = 'Your code failed one or more hidden tests.';
$string['filloutoneanswer'] = 'You must enter Python source code that satisfies the specification. The code you enter will be executed by a Python interpreter to determine its correctness and a grade awarded accordingly.';
$string['hidden'] = 'Hidden';
$string['missingoutput'] = 'You must supply the expected output from this test case.';
$string['missingshellinput'] = 'Output with no corresponding shell input?!';
$string['noerrorsallowed'] = 'Your code must pass all tests to earn any marks. Try again.';
$string['pycode'] = 'Python code';
$string['pycode_help'] = 'In response to a question, which is a specification for a Python function, the respondent enters Python source code that defines the required function.';
