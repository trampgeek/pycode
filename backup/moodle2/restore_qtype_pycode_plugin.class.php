 ...
 * needed to restore one pycode qtype plugin
 */
class restore_qtype_pycode_plugin extends restore_qtype_plugin {
    ...
    public function process_testcases($data) {
        ...
        if ($questioncreated) {
            ...
            // Insert record
            $newitemid = $DB->insert_record('question_pycode_testcases', $data);
        } else {
