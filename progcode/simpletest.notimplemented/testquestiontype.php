...
/**
 * Unit tests for the progcode question type class.
 *
 * @package    qtype
 * @subpackage progcode
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_progcode_test extends UnitTestCase {
    protected $qtype;

    public function setUp() {
        $this->qtype = new qtype_progcode();
    }
    ...
    public function test_name() {
        $this->assertEqual($this->qtype->name(), 'progcode');
    }
