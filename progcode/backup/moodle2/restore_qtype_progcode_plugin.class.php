 ...
 * needed to restore one progcode qtype plugin
 */
abstract class restore_qtype_progcode_plugin extends restore_qtype_plugin {
    
    // Subclasses must implement the following function to return qtype, e.g. pycode
